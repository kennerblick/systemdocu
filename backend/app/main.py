...
from .routers import servers, services, instances, environments, applications, zabbix_scan, export_excel, export_graphml, internet, clusters, storages, db_transfer
...
app.include_router(export_graphml.router)
